    ...
    struct basic_table : table
    {
        ...
        /*!
            ...
            \note If using `F` and `offset` to retrieve a specific field, use
                `WALLSTREETBETS_FIELD` macro in `src/lmdb/util.h` which calculates the
        ...
        */
        ...
        {
            static_assert(std::is_same<U, V>(), "bad WALLSTREETBETS_FIELD?");
        ...
        */
        ...
        {
            WALLSTREETBETS_PRECOND(cur != nullptr);
